...
Busca en la web: razón social, un resumen breve de la actividad y el sitio
web oficial. Los montos de importaciones NO salen de acá: la fuente es la
base ANA IMPO (Excel). Todo lo que devuelve es un borrador que el usuario
revisa y puede corregir antes de generar el PDF.
"""
...
_SCHEMA = {
    ...
    "schema": {
        ...
        "required": ["razon_social", "resumen", "sitio_web", "fuentes"],
...
Si un dato no aparece con certeza, devolvé null en ese campo. No inventes información."""


def _vacio() -> dict:
    return {"razon_social": None, "resumen": None, "sitio_web": None, "fuentes": []}
